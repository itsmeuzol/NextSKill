  ...
  return (
    <Wrapper>
      <section className="one">
        <nav className="z-indextop">
          <ul className="d-flex navbar-link">
            <li>Get Started</li>
            <li className="logo">
              <span className="circle-border">N S</span> <span>Next Skill</span>
            </li>
            <li>About</li>
          </ul>
        </nav>
      ...
      <section className="six">
        ...
        <p className="six-p">
          Next Skill, a free-lancing social media platform, is aimed for
          ...
          applicants, Next Skill offers total transparency in their application
        ...
        <p className="six-p">
          To address these, Next Skill was founded. With this platform, the job
      ...
      <section className="footer">
        <div className="footer-content">
          ...
          <ul className="footer-link">
            ...
            <li className="footer-text">Next Skill@gmail.com</li>
          </ul>
        </div>
        ...
        <div className="copyright">
          Copyrights © 2022 Next Skill’Media. All rights reserved.
        </div>
      </section>
    </Wrapper>
  );
